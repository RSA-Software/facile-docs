...
!!! warning "Se non trovi il menu, la tua versione non lo prevede"
    ...
    averlo occorre passare dall'assistenza, che riabilita il ramo con una
    versione allestita per quel settore.

## Cosa c'è in queste pagine

| Pagina | Versione che la attiva | Cosa contiene |
|---|---|---|
...
Sotto **Procedure Personali** ci sono anche cinque tabelle — Gruppi Clienti,
Tipi Attività, Nature Giuridiche, Tipi Contabilità e Coordinatori — che usano la
maschera comune delle tabelle, ed è lì che sono documentate: vedi
[Tabelle di classificazione](../magazzino/tabelle-di-classificazione.md). Anche
loro spariscono con il ramo, con una sola eccezione: **Tipi Attività** si
raggiunge anche da **Archivi ▸ Altre Tabelle**, che resta in tutte le
versioni.
