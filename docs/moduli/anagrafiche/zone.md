...
### Ritrovare e modificare una zona

1. Apri **Menu ▸ Archivi ▸ Zone ▸ Modifica**. La maschera non si apre vuota:
   mostra già la zona con il **codice più alto**.
2. Premi **F5 - Cerca** e scegli la zona dall'elenco, oppure scorri con **F3 -
   Prec.** e **F4 - Succ.**.
...
Finché non salvi puoi tornare indietro con **Ricarica**, che rilegge la zona
