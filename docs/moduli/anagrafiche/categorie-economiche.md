...
| *Non è possibile eliminare il record poiché utilizzato in alcuni record del database.* | La categoria è assegnata a un cliente o a un fornitore. | Non è eliminabile: prima cambia categoria a chi la usa. |
