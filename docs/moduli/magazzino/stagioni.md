...
| *Non è possibile eliminare il record poiché utilizzato in alcuni record del database.* | La stagione è assegnata a degli articoli, a contratti o a un calcolo scorte. | Non è eliminabile: prima cambia stagione agli articoli che la usano. |
